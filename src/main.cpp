...
#if defined(NDEBUG)
#error "BitBlocks cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight <= 400000 && nHeight >= 100001) {
        nSubsidy = 100 * COIN;
    }
	else if (nHeight <= 700000 && nHeight >= 400001) {
        nSubsidy = 90 * COIN;
    }
	else if (nHeight <= 1000000 && nHeight >= 700001) {
        nSubsidy = 80 * COIN; // 85200000 coins generated until block 1000000 / ~ 1 year
    }
	else if (nHeight <= 1200000 && nHeight >= 1000001) {
        nSubsidy = 70 * COIN; // + 14000000 coins generated / ~ 0.2 year
    }
	else if (nHeight <= 1500000 && nHeight >= 1200001) {
        nSubsidy = 60 * COIN; // + 18000000 coins generated / ~ 0.3 year
    }
	else if (nHeight <= 2000000 && nHeight >= 1500001) {
        nSubsidy = 50 * COIN; // + 25000000 coins generated / ~ 0.5 year / total: 142200000 coins generated in  ~ 2 years
    }
	else if (nHeight <= 2500000 && nHeight >= 2000001) {
        nSubsidy = 45 * COIN; // + 22500000 coins generated / ~ 0.5 year
    }
	else if (nHeight <= 3000000 && nHeight >= 2500001) {
        nSubsidy = 40 * COIN; // + 20000000 coins generated / ~ 0.5 year
    }
	else if (nHeight <= 3500000 && nHeight >= 3000001) {
        nSubsidy = 35 * COIN; // + 17500000 coins generated / ~ 0.5 year
    }
	else if (nHeight <= 4000000 && nHeight >= 3500001) {
        nSubsidy = 30 * COIN; // + 15000000 coins generated / ~ 0.5 year
    }
	else if (nHeight <= 4500000 && nHeight >= 4000001) {
        nSubsidy = 25 * COIN; // + 12500000 coins generated / ~ 0.5 year 
    }
	else if (nHeight <= 5000000 && nHeight >= 4500001) {
        nSubsidy = 20 * COIN; // + 10000000
    }
	else if (nHeight <= 5500000 && nHeight >= 5000001) {
        nSubsidy = 15 * COIN; // + 7500000
    }
	else if (nHeight <= 6000000 && nHeight >= 5500001) {
        nSubsidy = 10 * COIN; // + 5000000
    }
	else if (nHeight <= 7000000 && nHeight >= 6000001) {
        nSubsidy = 8 * COIN;  // + 8000000
    }
	else if (nHeight <= 8000000 && nHeight >= 7000001) {
        nSubsidy = 6 * COIN;  // + 6000000
    }
	else if (nHeight <= 9000000 && nHeight >= 8000001) {
        nSubsidy = 4 * COIN;  // + 4000000
    }
	else if (nHeight <= 10000000 && nHeight >= 9000001) {
        nSubsidy = 2 * COIN;  // + 2000000
    }
	else if (nHeight <= 20000000 && nHeight >= 10000001) {
        nSubsidy = 1 * COIN;  // + 10000000
    }
	else if (nHeight <= 50000000 && nHeight >= 20000001) {
        nSubsidy = 0.5 * COIN;// + 15000000 / TOTAL: 297200000 coins in ~ 50 years
    }
    else {
        nSubsidy = 0.1 * COIN;
    }
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
	...
	else if (nHeight <= 2000001 && nHeight >= 1500001) {
	...
	else if (nHeight <= 30000000 && nHeight >= 20000001) {
        ret = blockValue * 0.795;
    }
	else if (nHeight <= 50000000 && nHeight >= 30000001) {
        ret = blockValue * 0.80;
    }
	else if (nHeight >= 50000001) {
        ret = blockValue * 0.90;
    }
        else   {
	ret = blockValue * 0.70;
...
{
    RenameThread("bitblocks-scriptch");
