...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(70200, uint256("0xf6f5e6c3a6ecc2db29a9813b7d11916f1e48e62edcfe50030306fd34b35ce0ca"));
	
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1542765500, // * UNIX timestamp of last checkpoint block
    141491,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0423fdaf7d290d3a887713cf213b73326d585a2ed30ad50fcfba9d65999f1f96171c46366ec753f4bfe7f9cfe8aff4f562529fe06181a3bf2e7ece2ff1049d0484");
        nDefaultPort = 58697;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // BitBlocks starting difficulty is 1 / 2^12
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045a38eac98835691804bde135230e91996eb5d096847f5cb7d6845fedae4e0e30070e5a465adc31d14abb88ac8454947e33de8785575f71b895d8046955a10b50") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1538226121;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3267500;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000072fa90af55d6d2e8c4ddefef154787e152b85b37e8a1bcfd20daf88cb78"));
        assert(genesis.hashMerkleRoot == uint256("0xcf6ae77e3244153c35e5c124da47c95622ed6abae882246e7a7047a645bd83e1"));
	...
	base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 25); // B
        ...
        strSporkKey = "044CE5C98F7551A473E79D52FF50A64A0F6DC1936D3764BA86E794171FF68DEBC823E0B1C69C4C064CAA91D0CBE6BF38730BBA8E9AE1B01EAC7F113A2D9CB66B1B";
        strObfuscationPoolDummyAddress = "BNenJG4adWV935wqTUSk31inGbTBJNs3Pi";
        nStartMasternodePayments = 1538226121;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // BitBlocks: 1 day
        nTargetSpacing = 1 * 60;  // BitBlocks: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
*/
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bitblocks addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bitblocks script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bitblocks BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitblocks BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitblocks BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // BitBlocks: 1 day
        nTargetSpacing = 1 * 60;        // BitBlocks: 1 minutes
